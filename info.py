...
support_chat_id = environ.get('SUPPORT_CHAT_ID', "-1001502386817")
reqst_channel = environ.get('REQST_CHANNEL_ID', "-1001791820618")
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/anumitultrabots')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "True")), False)
IMDB = is_enabled((environ.get('IMDB', "True")), True)
AUTO_FFILTER = is_enabled((environ.get('AUTO_FFILTER', "True")), True)
AUTO_DELETE = is_enabled((environ.get('AUTO_DELETE', "True")), True)
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "True")), True)
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", '''📂 ɴᴀᴍᴇ: <code>{file_name}</code> \n\nᴊᴏɪɴ ɴᴏᴡ: [Ultra 𝙱𝚘𝚝](https://t.me/anumitultrabots) \n\n& 𝚂𝚞𝚋𝚜𝚌𝚛𝚒𝚋𝚎: [Ultra 𝚈𝚃](https://youtube.com/@anumitultrabots)''')
...
SHORTENER_API = environ.get("SHORTENER_API", "bf472da2209c269f595f9b6ac3444aa45c0cfe35")
